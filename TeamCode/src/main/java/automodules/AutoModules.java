...
public class AutoModules {
    ...
    public StageList OneDuckAutoBlue = new StageList(bot.carousel.spinOneDuckMoving(4,0.3,0.6, 1.0, 0.0, 0.14, 0.0));
    public StageList OneDuckAutoRed = new StageList(bot.carousel.spinOneDuckMoving(4,0.3,0.6,-1.0, 0.0, 0.14, 0.0));
